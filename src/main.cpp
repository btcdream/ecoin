...
unsigned int nStakeMinAge = 60 ;	// minimum age for coin age: 3h
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "ecoin is too later";
        CTransaction txNew;
       ...
       if (false )
        ...
        assert(block.hashMerkleRoot == uint256("c676b6aff6120c85c93632d80abff5df6727ba3882c67920615543844efcca22"));
