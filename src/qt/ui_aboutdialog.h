...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About eCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>eCoin</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 The eCoin developers", 0));
