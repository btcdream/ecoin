...
**
** Created: Wed Dec 25 20:30:02 2013
...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitcoin</b> version", 0));
