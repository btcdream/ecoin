...
**
** Created: Wed Dec 25 20:27:35 2013
...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Bitcoin - Debug window", 0));
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Bitcoin-Qt help message to get a list with possible Bitcoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
