...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 eCoin"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 eCoin"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 eCoin"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 eCoin"));
