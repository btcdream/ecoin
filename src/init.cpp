...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to ecoind / RPC client
            std::string strUsage = _("Bitcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  ecoin [options]                     " + "\n" +
                  "  ecoin [options] <command> [params]  " + _("Send command to -server or ecoin") + "\n" +
                  "  ecoin [options] help                " + _("List commands") + "\n" +
                  "  ecoin [options] help <command>      " + _("Get help for a command") + "\n";
